...
const pages = [
  ...
  {
    path: "pages/community/chatRoom/index",
    style: {
...
const subPackages = [
  {
    root: "subpackage/notification_detail",
    pages: [
      {
        path: "index",
        style: {
  ...
  {
    root: "subpackage/teamDetail",
    pages: [
      {
        path: "index",
        style: {
          navigationBarTitleText: "队伍信息"
        }
      }
    ]
  }
